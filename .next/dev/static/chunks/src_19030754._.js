...
function BrandMark({ href = "#top", size = "md", showName = false, className = "" }) {
    ...
    const { lang } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
    const safeLang = lang === "en" ? "en" : "no";
    const logoSrc = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$siteConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteConfig"].brand.logo?.src ?? "/icons/logo-green.png";
...
//# sourceMappingURL=src_19030754._.js.map